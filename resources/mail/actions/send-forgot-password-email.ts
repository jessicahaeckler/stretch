...
export async function sendForgotPasswordEmail({
  ...
  await transport.sendMail({
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 10px;">
      <h2 style="text-align: center; color: #eab308;">stretch app</h2>

      <p>Hi there,</p>

      <p>Please use the link below to access the reset password form on stretch app. This link will expire in ${VERIFICATION_TOKEN_EXP_MIN} minutes. If you don't think you should be receiving this email, you can safely ignore it.</p>
      ...
      <p>You received this email because you send a forgot password request for stretch app.</p>

      <p style="text-align: center; font-size: 12px; color: #aaa;">&copy; 2024 stretch app. All rights reserved.</p>
    </div>
    `,
  });
}
